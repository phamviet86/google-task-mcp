...
[GitHub Release `v0.3.1`](https://github.com/phamviet86/google-task-mcp/releases/tag/v0.3.1), phát
...
`$HOME/.local/share/google-tasks-mcp/v0.3.1/venv/bin/google-tasks-mcp`. File cấu hình MCP không tự
...
`/duong-dan-home-tuyet-doi/.local/share/google-tasks-mcp/v0.3.1/venv/bin/google-tasks-mcp`, và
...
token. macOS và Linux được hỗ trợ cho `v0.3.1`; Windows chưa được kiểm chứng.
