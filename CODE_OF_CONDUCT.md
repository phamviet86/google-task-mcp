...
When an incident does occur, it is important to report it promptly. Contact the project maintainers
using a private contact method published on the
[repository owner's GitHub profile](https://github.com/phamviet86). If no private method is listed,
use GitHub's content-reporting controls for content hosted on GitHub. Do not publish incident
details, personal information, or evidence in an issue or discussion.
...
Moderators to use their discretion and judgment, in keeping with the best interests of our
community.
...
[FAQ](https://www.contributor-covenant.org/faq). Translations are provided on the
[translations page](https://www.contributor-covenant.org/translations). Additional enforcement and
community guideline resources are available from the
[moderation resources](https://www.contributor-covenant.org/resources). The enforcement ladder was
